...
window.AlgoWidgets[2] = function(container) {
  container.innerHTML = '<div class="algo-widget">' +
    ...
    function render() {
      ...
      polyPtr.setAttribute('fill', 'var(--brand-500)'); 
      ...
      s.visual.pointers.forEach(function(ptr) {
        ...
        pointerText.setAttribute('y', ptr.y); 
        ...
        arrowLine.setAttribute('y1', ptr.y - 15); 
        arrowLine.setAttribute('x2', ptr.x);
        arrowLine.setAttribute('y2', ptr.y - 25); 
...
window.AlgoWidgets[4] = function(container) {
  container.innerHTML = '<div class="algo-widget">' +
        ...
        function generateSteps() {
          steps = [];
          completedPaths = { pre: null, in: null, post: null }; 
          ...
          completedPaths.pre = preorderPath.slice(); 
          ...
          completedPaths.in = inorderPath.slice(); 
          ...
          completedPaths.post = postorderPath.slice(); 
...
window.AlgoWidgets[5] = function(container) {
  container.innerHTML = '<div class="algo-widget">' +
    ...
    function generateSteps() {
      steps = [];
      basePoints = [];
      var numPoints = Math.floor(Math.random() * 6) + 12; 
